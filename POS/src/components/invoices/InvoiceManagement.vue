									...
									>
										...
										<div class="px-5 py-3 bg-gray-50 border-t border-gray-200 flex items-center justify-end gap-2">
											...
											<button
												...
												@click="$emit('copy-invoice', invoice)"
												class="px-3 py-2 text-xs font-semibold text-teal-600 bg-teal-50 hover:bg-teal-100 rounded-lg transition-colors flex items-center gap-1"
