...
This document explains how POS-ABS integrates with ERPNext's Pricing Rules and Promotional Schemes to automatically apply discounts.

## Overview

POS-ABS supports automatic offer application based on cart contents. When items are added to the cart, the system:
...
When you save a Promotional Scheme, ERPNext automatically creates underlying Pricing Rules (e.g., `PRLE-0003`). POS-ABS works with these generated rules.
