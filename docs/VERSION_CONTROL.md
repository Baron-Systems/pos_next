# POS-ABS - Version Control System

This document explains the version control mechanism implemented in POS-ABS.

## Overview

POS-ABS uses a comprehensive version control system that tracks both application versions and build versions for effective cache busting and version management.
...
- **Location**: POS-ABS uses `public/pos/` for build assets
- **Fallback**: POS-ABS checks manifest.webmanifest mtime as additional fallback
- **Script**: POS-ABS includes automated version bump script
- **Documentation**: POS-ABS has comprehensive version management guide
