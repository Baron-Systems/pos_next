...
def get_branding_config():
	...
	try:
		...
		frappe.log_error(f"Error fetching branding config: {str(e)}", "Al Baron System Branding")
		# Return default config even on error
		return {
			"_t": base64.b64encode("Powered by".encode()).decode(),
			"_l": base64.b64encode("Al Baron System".encode()).decode(),
			"_u": base64.b64encode("https://albaronsystems.com".encode()).decode(),
			"_i": 10000,
			"_v": True,
			"_e": 1
		}
